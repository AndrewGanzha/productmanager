<template>
  <div class="fixed top-1.5 left-1.5 sm:top-2 sm:left-2 md:top-3 md:left-3 lg:top-4 lg:left-4 z-[1000]">
        ...
        >
          ...
          >
            <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" viewBox="0 0 16 16" fill="currentColor">
              ...
              <path
                fill-rule="evenodd"
                d="M11.854 8.354a.5.5 0 000-.708l-3-3a.5.5 0 10-.708.708L10.293 7.5H5.5a.5.5 0 000 1h4.793l-2.147 2.146a.5.5 0 00.708.708l3-3z"
              />
            </svg>
    ...
    >
      <div
        class="w-8 h-8 border-2 border-white/10 border-t-blue-400 rounded-full animate-spin"
      ></div>
    </div>
  </div>
</template>
